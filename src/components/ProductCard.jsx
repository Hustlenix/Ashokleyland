...
const ProductCard = ({ 
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-3/5 p-8">
            ...
            <Link
              to={link}
              className="inline-flex items-center gap-2 text-[#E11D48] font-semibold group-hover:gap-3 transition-all"
            >
              View Details
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <h3 className="text-xl font-bold text-[#0B1F3A] mb-2 group-hover:text-[#E11D48] transition-colors">
          {name}
        </h3>
        ...
        >
          ...
          <div className="w-8 h-8 rounded-full bg-[#E11D48]/10 flex items-center justify-center group-hover:bg-[#E11D48] transition-colors">
            <ArrowRight className="w-4 h-4 text-[#E11D48] group-hover:text-white transition-colors" />
          </div>
        </Link>
      </div>
    </div>
