  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <h3 className="text-xl font-bold text-[#0B1F3A] mb-3 line-clamp-2 group-hover:text-[#E11D48] transition-colors duration-200">
          {title}
        </h3>
        ...
        {link && link !== '#' && (
          <a
            ...
            className="inline-flex items-center gap-2 text-[#E11D48] font-semibold text-sm group-hover:gap-3 transition-all duration-200"
          >
            Read More
